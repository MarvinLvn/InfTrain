...
# to be deleted
JOBSCRATCH=/private/home/marvinlvn/InfTrain/InfTrain_models
MODELS_PATH=/checkpoint/marvinlvn/InfTrain/InfTrain_models
...
start=`date +%s`
srun python /private/home/marvinlvn/InfTrain/fairseq/train.py --fp16 /private/home/marvinlvn/InfTrain/EN_50h_00/fairseq_bin_data \
...
--seed 5 --log-format simple --log-interval 1 --skip-invalid-size-inputs-valid-test \
