...
# 3) Train models
MODEL_OUTPUT=${MODELS_PATH}/${LANGUAGE}/${SIZE}/${SHARE}/bert_small
...
--max-tokens $MAX_TOKENS --update-freq $UPDATE_FREQ --max-update 5000000 --encoder-embed-dim 512 --encoder-ffn-embed-dim 2048 --encoder-attention-heads 8 --encoder-layers 8 \
