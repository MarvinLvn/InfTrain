...
PATH_CHECKPOINT_DIR=experiments/checkpoints/cv/1m/mono/mono_${lang}
...
sbatch -o ${PATH_CHECKPOINT_DIR}/train_CPC_small.txt ./trainers/train_cpc_small_CV_1m.sh $PATH_AUDIO_FILES $PATH_CHECKPOINT_DIR $PATH_TRAIN $PATH_VAL $NB_EPOCHS
